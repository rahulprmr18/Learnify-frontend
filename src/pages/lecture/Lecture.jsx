...
const Lecture = ({ user }) => {
  ...
  async function fetchProgress() {
    try {
      ...
      setCompleted(data.coursProgressPercentage);
              ...
              {lectures && lectures.length > 0 ? (
                lectures.map((e, i) => (
                  <React.Fragment key={e._id}>
                    ...
                    >
                      {i + 1}. {e.title}{" "}
                      {progress && progress.completedLectures && progress.completedLectures.includes(e._id) &&
                        <span><TiTick/></span>}
                    </div>
                    {user && user.role === "admin" && (
                      <button
...
export default Lecture; // Ensure this line is present